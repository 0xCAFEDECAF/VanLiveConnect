...
<html lang="en">
  <head>
    ...
    <meta charset='utf-8'>
    <!--<meta name="viewport" content="width=1350">-->  <!-- Works on mobile Firefox, also full-screen -->
    ...
    <div style="position:absolute; left:0px; top:0px; width:390px; height:550px;">
      ...
      <div id="trip_info" style="display:block;">
        ...
        <div class="tab" style="left:30px; top:27px; width:500px; height:100px;">
          <button id="trip_1_button" class="tablinks active" style="left:0px; top:8px; width:120px; height:60px;" onclick="openTab(event, 'trip_1');">1</button>
          <button id="trip_2_button" class="tablinks" style="left:115px; top:8px; width:120px; height:60px;" onclick="openTab(event, 'trip_2');">2</button>
        </div>
    ...
    <div style="position:absolute; left:390px; top:0px; width:960px; height:550px;">
      ...
      <div id="audio" style="display:none;">
        ...
        <div id="tuner" style="display:none;">
          ...
          <div id="scan_direction_up" class="led ledOff fa fa-caret-up" style="left:375px; top:40px; width:40px; height:37px;"></div>
          <div id="scan_direction_down" class="led ledOff fa fa-caret-down" style="left:375px; top:83px; width:40px; height:37px;"></div>
          ...
          <div class="tag" style="left:20px; top:420px; width:150px;">Tuner</div>
          <div id="scan_sensitivity_dx" class="led ledOff" style="left:190px; top:430px; width:80px;">Dx</div>
          <div id="scan_sensitivity_lo" class="led ledOff" style="left:280px; top:430px; width:80px;">Lo</div>

          <div class="tag" style="left:690px; top:420px; width:160px;">Signal</div>
          <div id="signal_strength" class="dots" style=" left:870px; top:415px;">--</div>
      ...
      <div id="pre_flight" style="display:none;">
        ...
        <div class="icon iconSmall" style="left:790px; top:363px;">
          <!--<div class="centerAligned far fa-lightbulb"></div>-->
          <div class="centerAligned far fa-sun"></div>
        </div>
        ...
        <div id="lights" class="led ledOff far fa-lightbulb" style="font-size:44px; line-height:1.3; left:320px; top:450px; width:80px;"></div>
      ...
      <div id="sat_nav" style="display:none;">
        ...
        <div id="satnav_curr_heading" style="position:absolute; left:570px; top:20px; width:48px; height:72px; transform:rotate(0deg); transform-origin:center;">
          <svg>
        ...
        <div id="satnav_select_from_memory_menu" class="tag menuTitle" style="display:none; left:30px; top:140px; width:920px; height:410px;">
          ...
          <div class="button buttonSelected">Personal directory</div>
          <div class="button">Professional directory</div>
        ...
        <div id="satnav_vocal_synthesis_level" class="tag menuTitle" style="display:none; left:60px; top:140px; width:920px; height:410px;">
          ...
          <!-- When the "Validate" button is pressed, all menus are exited up to top level.
               IMHO that is a bug in the system. -->
          <div
            class="button buttonSelected"
        ...
        <div id="satnav_enter_destination" style="display:none;">
          ...
          <div id="satnav_enter_characters" style="display:none;">
            ...
            <div id="satnav_to_mfd_show_characters_line_2"
              ...
              style="left:25px; top:360px; width:925px; font-size:50px; line-height:1.5; display:inline-block;
                background-color:rgb(41,55,74); color:#dfe7f2; border-style:none;">YZ'_</div>
            <div
          ...
          <div id="satnav_choose_from_list" on_exit="menuStack.pop();" style="display:none;">
            ...
            <!-- TODO - id="satnav_software_modules_list": show this? -->
                <!--overflow:scroll; overflow-x:hidden; white-space:nowrap;">-->
        ...
        <div id="satnav_show_address" style="display:none;">
          ...
          <div id="satnav_show_place_of_interest_address" style="display:none;">
            ...
            <div class="tag" style="left:25px; top:190px; width:190px; text-align:left; font-size:40px;">City</div>
            <div gid="satnav_place_of_interest_address_city" class="dots" style="left:210px; top:195px; width:750px; height:90px; font-size:40px; white-space:normal;">
            </div>

            <div class="tag" style="left:25px; top:280px; width:190px; text-align:left; font-size:40px;">Street</div>
            <div gid="satnav_place_of_interest_address_street" class="dots" style="left:210px; top:285px; width:750px; height:90px; font-size:40px; white-space:normal;">
            </div>
        ...
        <div id="satnav_guidance" style="display:none;">
          ...
          <div id="satnav_distance_to_dest_via_road" class="dots" style=" left:530px; top:457px; width:170px; text-align:right;">-</div>
          <div id="satnav_distance_to_dest_via_road_km" class="led ledOn" style="left:710px; top:472px; width:35px;">k</div>
          <div class="led ledOn" style="left:745px; top:472px; width:40px;">m</div>
          ...
          <div style="border:5px solid #dfe7f2; border-radius:15px; position:absolute; overflow: hidden; left:350px; top:120px; width:590px; height:140px;">
            <div gid="satnav_next_street" class="centerAligned" style="font-size:40px; white-space:normal;">
            </div>
          </div>
          <div style="border:5px solid #dfe7f2; border-radius:15px; border-style:dotted; position:absolute; overflow: hidden; left:350px; top:280px; width:590px; height:140px;">
            <div gid="satnav_curr_street" class="centerAligned" style="font-size:40px; white-space:normal;">
            </div>
          </div>
          ...
          <div style="border: 5px solid #dfe7f2; border-radius:15px; position:absolute; left:20px; top:120px; width:300px; height:390px;">
            ...
            <div id="satnav_turn_at_indication" style="display:block;">
              <div id="satnav_turn_at" class="dots" style=" left:5px; top:285px; width:170px; text-align:right;">-</div>
              <div id="satnav_turn_at_km" class="led ledOn" style="left:180px; top:300px; width:35px;">k</div>
              <div class="led ledOn" style="left:215px; top:300px; width:40px;">m</div>
            </div>
      ...
      <div id="audio_settings_popup" class="icon notificationPopup" style="display:none; top:80px; height:430px;">
        ...
        <div id="loudness" class="led ledOn" style="left:200px; top:360px; width:150px;">LOUD</div>
